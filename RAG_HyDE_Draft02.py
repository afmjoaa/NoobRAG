...
def generate_hypothetical_answer(query: str) -> str:
    ...
    print("\n[HyDE] Hypothetical answer generated by model 'mistral':")
...
def getCombinedContext(query: str = "What is a second brain?", top_k: int = 5, max_docs: int = 6, will_print: bool = True, use_hyde: bool = True):
    if use_hyde:
        query = generate_hypothetical_answer(query)
...
def getPrompt(query: str = "What is a second brain?", top_k: int = 5, max_docs: int = 6, will_print: bool = True, use_hyde: bool = False):
...
def getGeneratedAnswer(query: str, top_k: int, max_docs: int, use_hyde: bool = False):
...
if __name__ == "__main__":
    ...
    # Step 2: Generate prompt and answer for the main query using forward HyDE
